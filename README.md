...
---
En la página principal de GitHub, haz clic en el botón verde **New** (Nuevo).

![Crear repositorio](./images/1-repo.png)

---
Completa el formulario:

![Opciones repositorio](./images/2-repo.png)
...
![Comandos](./images/3-repo.png)

---
Pegalos en local:

![Repositorio local](./images/4-terminal.png)
